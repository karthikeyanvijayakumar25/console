\hypertarget{group__ClassicRateMon}{}\section{Rate Monotonic Scheduler}
\label{group__ClassicRateMon}\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
\subsection*{Files}
...
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{group__ClassicRateMon_ga4fd95c35783d891d39c1258ed6797d54}\label{group__ClassicRateMon_ga4fd95c35783d891d39c1258ed6797d54}} 
...
\mbox{\Hypertarget{group__ClassicRateMon_gaf1f0419cc6ef710bd429a5e7a01242c4}\label{group__ClassicRateMon_gaf1f0419cc6ef710bd429a5e7a01242c4}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!RTEMS\_PERIOD\_STATUS@{RTEMS\_PERIOD\_STATUS}}
\index{RTEMS\_PERIOD\_STATUS@{RTEMS\_PERIOD\_STATUS}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
\subsubsection{\texorpdfstring{RTEMS\_PERIOD\_STATUS}{RTEMS\_PERIOD\_STATUS}}
...
\mbox{\Hypertarget{group__ClassicRateMon_ga0fd6fa9e7304b022e004061d542ca743}\label{group__ClassicRateMon_ga0fd6fa9e7304b022e004061d542ca743}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_period\_states@{rtems\_rate\_monotonic\_period\_states}}
\index{rtems\_rate\_monotonic\_period\_states@{rtems\_rate\_monotonic\_period\_states}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
...
The following enumerated type defines the states in which a period may be. \begin{DoxyEnumFields}{Enumerator}
\raisebox{\heightof{T}}[0pt][0pt]{\index{RATE\_MONOTONIC\_INACTIVE@{RATE\_MONOTONIC\_INACTIVE}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!RATE\_MONOTONIC\_INACTIVE@{RATE\_MONOTONIC\_INACTIVE}}}\mbox{\Hypertarget{group__ClassicRateMon_gga0fd6fa9e7304b022e004061d542ca743a93a81a6de0cce64ccd61a58f824af62e}\label{group__ClassicRateMon_gga0fd6fa9e7304b022e004061d542ca743a93a81a6de0cce64ccd61a58f824af62e}} 
R\+A\+T\+E\+\_\+\+M\+O\+N\+O\+T\+O\+N\+I\+C\+\_\+\+I\+N\+A\+C\+T\+I\+VE&This value indicates the period is off the watchdog chain, and has never been initialized. \\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{RATE\_MONOTONIC\_ACTIVE@{RATE\_MONOTONIC\_ACTIVE}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!RATE\_MONOTONIC\_ACTIVE@{RATE\_MONOTONIC\_ACTIVE}}}\mbox{\Hypertarget{group__ClassicRateMon_gga0fd6fa9e7304b022e004061d542ca743a7c7ebd4009fee0bb884b0d3fcdc6b336}\label{group__ClassicRateMon_gga0fd6fa9e7304b022e004061d542ca743a7c7ebd4009fee0bb884b0d3fcdc6b336}} 
R\+A\+T\+E\+\_\+\+M\+O\+N\+O\+T\+O\+N\+I\+C\+\_\+\+A\+C\+T\+I\+VE&This value indicates the period is on the watchdog chain, and running. The owner should be executed or blocked waiting on another object. \\
\hline

\raisebox{\heightof{T}}[0pt][0pt]{\index{RATE\_MONOTONIC\_EXPIRED@{RATE\_MONOTONIC\_EXPIRED}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!RATE\_MONOTONIC\_EXPIRED@{RATE\_MONOTONIC\_EXPIRED}}}\mbox{\Hypertarget{group__ClassicRateMon_gga0fd6fa9e7304b022e004061d542ca743a7ee68c8b88a188cf669b524401b2c7bd}\label{group__ClassicRateMon_gga0fd6fa9e7304b022e004061d542ca743a7ee68c8b88a188cf669b524401b2c7bd}} 
R\+A\+T\+E\+\_\+\+M\+O\+N\+O\+T\+O\+N\+I\+C\+\_\+\+E\+X\+P\+I\+R\+ED&This value indicates the period is off the watchdog chain, and has expired. The owner is still executing and has taken too much all time to complete this iteration of the period. \\
\hline
...
\mbox{\Hypertarget{group__ClassicRateMon_ga4313840d58c7a2ccc4b1e6151e712bf7}\label{group__ClassicRateMon_ga4313840d58c7a2ccc4b1e6151e712bf7}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_cancel@{rtems\_rate\_monotonic\_cancel}}
\index{rtems\_rate\_monotonic\_cancel@{rtems\_rate\_monotonic\_cancel}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
\subsubsection{\texorpdfstring{rtems\_rate\_monotonic\_cancel()}{rtems\_rate\_monotonic\_cancel()}}
...
\hline
\end{DoxyRetVals}
\mbox{\Hypertarget{group__ClassicRateMon_gab599ee7e8f65f1d1461a3a5e198491eb}\label{group__ClassicRateMon_gab599ee7e8f65f1d1461a3a5e198491eb}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_create@{rtems\_rate\_monotonic\_create}}
\index{rtems\_rate\_monotonic\_create@{rtems\_rate\_monotonic\_create}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
...
This routine implements the rate\+\_\+monotonic\+\_\+create directive. The period will have the name name. It returns the id of the created period in ID. \mbox{\Hypertarget{group__ClassicRateMon_ga51fbaab06f60134917d571c6116396ea}\label{group__ClassicRateMon_ga51fbaab06f60134917d571c6116396ea}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_delete@{rtems\_rate\_monotonic\_delete}}
\index{rtems\_rate\_monotonic\_delete@{rtems\_rate\_monotonic\_delete}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
...
\hline
\end{DoxyRetVals}
\mbox{\Hypertarget{group__ClassicRateMon_ga56f6fb057c562aaf77959bbb3b9d0762}\label{group__ClassicRateMon_ga56f6fb057c562aaf77959bbb3b9d0762}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_get\_statistics@{rtems\_rate\_monotonic\_get\_statistics}}
\index{rtems\_rate\_monotonic\_get\_statistics@{rtems\_rate\_monotonic\_get\_statistics}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
\subsubsection{\texorpdfstring{rtems\_rate\_monotonic\_get\_statistics()}{rtems\_rate\_monotonic\_get\_statistics()}}
...
\hline
\end{DoxyRetVals}
\mbox{\Hypertarget{group__ClassicRateMon_ga6bec49e7ccb1b6074438e301c0f1f92e}\label{group__ClassicRateMon_ga6bec49e7ccb1b6074438e301c0f1f92e}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_get\_status@{rtems\_rate\_monotonic\_get\_status}}
\index{rtems\_rate\_monotonic\_get\_status@{rtems\_rate\_monotonic\_get\_status}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
...
\hline
\end{DoxyRetVals}
\mbox{\Hypertarget{group__ClassicRateMon_ga84840acb8f43fd0c19c00236e17737d8}\label{group__ClassicRateMon_ga84840acb8f43fd0c19c00236e17737d8}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_ident@{rtems\_rate\_monotonic\_ident}}
\index{rtems\_rate\_monotonic\_ident@{rtems\_rate\_monotonic\_ident}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
...
\hline
\end{DoxyRetVals}
\mbox{\Hypertarget{group__ClassicRateMon_ga4ad92b1400f90f5078ff3302f20da372}\label{group__ClassicRateMon_ga4ad92b1400f90f5078ff3302f20da372}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_period@{rtems\_rate\_monotonic\_period}}
\index{rtems\_rate\_monotonic\_period@{rtems\_rate\_monotonic\_period}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
...
\hline
\end{DoxyRetVals}
\mbox{\Hypertarget{group__ClassicRateMon_ga556dec002aada3b85d6af370fe233848}\label{group__ClassicRateMon_ga556dec002aada3b85d6af370fe233848}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_report\_statistics@{rtems\_rate\_monotonic\_report\_statistics}}
\index{rtems\_rate\_monotonic\_report\_statistics@{rtems\_rate\_monotonic\_report\_statistics}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
...
This routine allows a thread to print the statistics information on A\+LL period instances which have non-\/zero counts using printk. \mbox{\Hypertarget{group__ClassicRateMon_ga062540df1e5b9d2c99ac1f372491d5e8}\label{group__ClassicRateMon_ga062540df1e5b9d2c99ac1f372491d5e8}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_report\_statistics\_with\_plugin@{rtems\_rate\_monotonic\_report\_statistics\_with\_plugin}}
\index{rtems\_rate\_monotonic\_report\_statistics\_with\_plugin@{rtems\_rate\_monotonic\_report\_statistics\_with\_plugin}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
...
This routine allows a thread to print the statistics information on A\+LL period instances which have non-\/zero counts using the R\+T\+E\+MS printer. The implementation of this directive straddles the fence between inside and outside of R\+T\+E\+MS. It is presented as part of the Manager but actually uses other services of the Manager. \mbox{\Hypertarget{group__ClassicRateMon_gacd99140676caf91d1fd3c6fd95e6a9c8}\label{group__ClassicRateMon_gacd99140676caf91d1fd3c6fd95e6a9c8}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_reset\_all\_statistics@{rtems\_rate\_monotonic\_reset\_all\_statistics}}
\index{rtems\_rate\_monotonic\_reset\_all\_statistics@{rtems\_rate\_monotonic\_reset\_all\_statistics}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
...
This routine allows a thread to reset the statistics information on A\+LL period instances. \mbox{\Hypertarget{group__ClassicRateMon_gafc3dfca5d5f9edc1d931da6d7c309386}\label{group__ClassicRateMon_gafc3dfca5d5f9edc1d931da6d7c309386}} 
\index{Rate Monotonic Scheduler@{Rate Monotonic Scheduler}!rtems\_rate\_monotonic\_reset\_statistics@{rtems\_rate\_monotonic\_reset\_statistics}}
\index{rtems\_rate\_monotonic\_reset\_statistics@{rtems\_rate\_monotonic\_reset\_statistics}!Rate Monotonic Scheduler@{Rate Monotonic Scheduler}}
